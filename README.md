...
<details>
<summary><strong>Hardware & Embedded</strong></summary>

- **[5-Stage Pipelined MIPS Processor](https://github.com/naman-ranka/mips-processor)** — 33 instructions, 12-path forwarding, CAM instruction cache, LL/SC atomics. SystemVerilog.
- **[Raspberry Pi Autonomous Bot](https://github.com/naman-ranka/AutonomousBotRaspberryPi)** — Lane following (OpenCV + PID), 4 object detectors, Arduino I2C integration, Bluetooth RC. Bachelor's capstone.
- **SiliconCrew** bridges both worlds — LLM agents generating and verifying RTL through the full ASIC flow (SkyWater 130nm, ASAP7 7nm).
...
- **Udacity Self-Driving Car Nanodegree** — Object detection (TensorFlow), 3D LiDAR, Extended Kalman Filter, ICP localization from scratch (SVD), motion planning, PID control. [Certificate earned.](https://github.com/naman-ranka/Localization_Udacity)
...
[LinkedIn](https://linkedin.com/in/namany) · [Trezzit](https://trezzit.com) · namanranka14@gmail.com

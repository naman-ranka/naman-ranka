...
- **[Raspberry Pi Autonomous Bot](https://github.com/naman-ranka/AutonomousBotRaspberryPi)** — Lane following (OpenCV + PID), 4 object detectors, Arduino I2C integration. Bachelor's capstone.
...
- **Udacity Self-Driving Car Nanodegree** — Object detection, 3D LiDAR, EKF, ICP localization from scratch (SVD), motion planning, PID control. [Certificate earned.](https://github.com/naman-ranka/Localization_Udacity)
